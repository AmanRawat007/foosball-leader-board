  ...
  <nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mynavbar">
        ...
        <ul class="navbar-nav">
          <li class="nav-item px-2">
            <a href="team_registered.php" class="nav-link active"> Total Team Registered</a>
          </li>
        </ul>
...
<!--header-->
  <header id="main-header" class="bg-info py-2 text-white">
    <div class="container">
      <div classs="row">
        <div class="col-md-6">
          <h1><i class="fa fa-group"></i> Total Team Registered</h1>
      </div>
    </div>
  </header>
...
<!--Footer-->
 <footer id="main-footer" class="text-center text-white bg-inverse mt-4  py-3">
   <div class="container">
     <div class="row">
       <div class="col">
